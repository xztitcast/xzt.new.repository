...
public class TbItemCat implements Serializable{
    ...
    @Column(name = "name", columnDefinition = "varchar(50) DEFAULT NULL COMMENT '类目名称'")
    ...
    @Column(name = "status", nullable = false, columnDefinition = "int(1) DEFAULT '1' COMMENT '状态。可选值:1(正常),2(删除)'")
